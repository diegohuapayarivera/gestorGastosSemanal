...
function preguntarPresupuesto() {
    ...
    //inicializando 
    presupuesto = new Presupuesto(presupuestUsuario)
...
function agregarGastos(e) {
    ...
    if (nombre === '' || cantidad === '') {
        ui.imprimirAlerta('Ambos campos son requeridos', 'error')
        return
    } else if (cantidad <= 0 || isNaN(cantidad)) {
        ui.imprimirAlerta('Cantidad no validar', 'error')
        return
    }
